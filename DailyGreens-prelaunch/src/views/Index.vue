    ...
    <parallax class="section page-header header-filter" :style="headerStyle">
      <div class="container">
        <div class="md-layout">
          ...
          >
            <h1 class="title">Self sustanace <br>has never been<br> so easy</h1>
            <h4>
              Punchline summary. Why its your moral obligation to eat greens, 
              and delicioulse, and yet somehow super easy, fun and clean.
            ...
            <md-button
              ...
              target="_blank"
              ><i class="fas fa-play"></i>START NOW</md-button
            >
          </div>
        </div>
      </div>
